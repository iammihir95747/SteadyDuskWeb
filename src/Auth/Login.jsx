            ...
            <div className="register">
                <div className="form">
                    <form action="/" className='form-block' autoComplete='off'>
                        ...
                        <input className='form-item' type="text" placeholder="Username" required={true} />

                        <label className='labelitem' htmlFor="email">Email Address *</label>
                        <input className='form-item' type="email" placeholder="Your email.com"   required={true} autoComplete='off' />

                        <label className='labelitem' htmlFor="password">Password *</label>
                        <input className='form-item' type="password" placeholder="Password" required={true} autoComplete='new-password' />

                        <label className='labelitem' htmlFor="address">Address</label>
                        <input className='form-item' type="text" placeholder="Address" />
                        ...
                        <div className="phone-input" style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                            <select className='form-item country-code' style={{ position: 'absolute', left: '10px', height: '100%',width:"150px", border: 'none', background: 'transparent' }} required>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <div className="cheakbox">
                            <input type="checkbox" className='cheakout' /> By creating a Classe365 account, you're agreeing to accept our terms of service.
                        </div>
